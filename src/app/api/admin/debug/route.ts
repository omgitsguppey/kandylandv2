...
} from "@/lib/server/admin-debug/truth-state";
...
function buildRolloutRegistryPanelState(input: {
    ...
    const rolloutItemsMap = new Map<string, RolloutRegistryItem>();
...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        if (section !== "all" && !loadFullDebug) {
            return finalize(NextResponse.json(await buildAdminDebugSummaryPayload({
                nowMs,
        ...
        const runtimeTaskSourceParityRowsByTaskId = new Map(
        ...
        runtimeTaskAudit.distribution.forEach((entry) => {
            ...
            const sourceParity = runtimeTaskSourceParityRowsByTaskId.get(entry.taskId);
        ...
        return finalize(NextResponse.json({
            ...
            adminAnalyticsHotCache: {
                ...
                historicalRouteAuthority: {
                    route: "/api/admin/analytics/historical",
                    canonicalSource: "analytics_admin_metric_snapshots",
                    fallbackEvidenceSource: "admin_debug_raw_evidence_only",
                    unavailableSource: "analytics_admin_metric_snapshots/unavailable",
                    compactDisplayRule: "Historical Admin Analytics sections read verified admin metric snapshots before raw/vendor sources.",
            ...
            adminAnalyticsAudienceSnapshot: {
                ...
                identifiedUsersSource: "window.__KANDYDROPS_ADMIN_ANALYTICS_AUDIENCE_SNAPSHOT_DEBUG__.identifiedViews.source",
                guestEstimateFormulaSource: "window.__KANDYDROPS_ADMIN_ANALYTICS_AUDIENCE_SNAPSHOT_DEBUG__.guestEstimateMetadata.formula",
                debugFields: [
                    "generatedAtUtc",
                    "selectedRange",
                    "sourceState",
                ...
                badgeLabels: ["LIVE", "STALE", "EST", "CACHE", "WAIT", "ERROR", "REVIEW"],
            },
            adminAnalyticsCommerceSnapshot: {
                ...
                generatedAtUtcSource: "window.__KANDYDROPS_ADMIN_ANALYTICS_COMMERCE_SNAPSHOT_DEBUG__.generatedAtUtc",
                cacheStateSource: "window.__KANDYDROPS_ADMIN_ANALYTICS_COMMERCE_SNAPSHOT_DEBUG__.cacheState",
                ...
                rangeRule: "Lifetime, 30D, and selected-range cards must stay labeled per card. Conversion is unavailable when purchases and checkout starts do not share scope.",
                treasuryRule: "Yield / 100 GD must define delivered GD and align with Platform Economy floor warnings.",
            ...
            adminAnalyticsEventMix: {
                ...
                contextRule: "Catalog-inferred categories must not be shown as verified route or surface context.",
            ...
            adminAnalyticsLiveInteractionStream: {
                ...
                liveTruthRule: "Backend snapshots are labeled SNAP or STALE; normal GA/Firebase batch exports must not be called live when the newest event falls outside the live threshold.",
            ...
            adminAnalyticsDailyTaskPipeline: {
                ...
                generatedAtUtc: "window.__KANDYDROPS_ADMIN_ANALYTICS_DAILY_TASK_PIPELINE_DEBUG__.generatedAtUtc",
                lastValidatedAtUtc: "window.__KANDYDROPS_ADMIN_ANALYTICS_DAILY_TASK_PIPELINE_DEBUG__.lastValidatedAtUtc",
                snapshotState: "window.__KANDYDROPS_ADMIN_ANALYTICS_DAILY_TASK_PIPELINE_DEBUG__.snapshotState",
            ...
            adminAnalyticsNotificationFunnel: {
                ...
                generatedAtUtc: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.generatedAtUtc",
                selectedRange: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.selectedRange",
                funnelState: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.state",
                denominatorMode: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.denominatorMode",
                missingSourceCount: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.missingSourceCount",
                ...
                duplicatePreventedCount: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.duplicatePreventedCount",
                failedSkippedCount: "window.__KANDYDROPS_ADMIN_ANALYTICS_NOTIFICATION_FUNNEL_DEBUG__.failedSkippedCount",
                ...
                partialFunnelRule: "Prompt, enabled, opened, read, and cleared are event-count summaries unless notification ids or users are explicitly linked.",
