    ...
    try {
        ...
        return NextResponse.json({
            ...
            recommendationDebug: {
                ...
                truthScore: behavioralProfile?.truthScore ?? recommendedDrops[0]?.truthScore ?? 0,
                mathCalibration: behavioralProfile?.mathCalibration ?? {
                    activeMode: "deterministic",
                    verdict: "deterministic_active",
                    reason: "No behavioral profile math calibration artifact is available yet.",
                },
