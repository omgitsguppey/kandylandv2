...
export default function DropsLoading() {
    return (
        <div className="mx-auto w-full max-w-7xl px-3 pt-[calc(var(--kandy-cookie-offset,0px)+0.75rem)] pb-4 sm:px-4 md:px-8 md:pt-0 md:pb-8">
            ...
            <div className="mb-4 h-44 animate-pulse rounded-[1.35rem] border border-white/10 bg-zinc-900/50 sm:h-64 md:h-[320px] md:rounded-[2rem]" />
            ...
            <div className="rounded-[1.45rem] border border-white/5 bg-white/[0.01] p-1.5 md:rounded-[2rem] md:p-6">
