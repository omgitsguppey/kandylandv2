...
export default function DropsLoading() {
    return (
        <main className="min-h-screen bg-black pt-24 md:pt-32 px-4 md:px-8 max-w-7xl mx-auto pb-24">
            ...
            <div className="mb-12 md:mb-16 flex flex-col items-center text-center animate-pulse">
            ...
            <div className="sticky top-20 z-40 py-4 mb-8">
                <div className="glass-panel p-2 rounded-2xl flex flex-col md:flex-row gap-4 border border-white/5 animate-pulse">
            ...
            {/* Grid Skeleton */}
            <div className="mt-8">
                <div className="flex items-center justify-between mb-8 px-4 md:px-0 animate-pulse">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="glass-panel p-4 md:p-6 rounded-2xl md:rounded-3xl border border-white/5 min-h-[350px] animate-pulse">
