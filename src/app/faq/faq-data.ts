...
export const HOW_IT_WORKS_STEPS: readonly HowItWorksStep[] = [
  {
    ...
    label: "Join",
    eyebrow: "Step 1",
    title: "Start with a free profile",
    description:
      "Create your account once so your stash, library, and daily progress stay with you on every visit.",
  ...
  },
  {
    ...
    label: "Get Gum Drops",
    eyebrow: "Step 2",
    title: "Keep Gum Drops ready",
    description:
      "Buy bundles or return to Experiences so your balance is ready before a live drop disappears.",
  ...
  },
  {
    ...
    label: "Unwrap",
    eyebrow: "Step 3",
    title: "Unwrap while it is live",
    description:
      "Open the drop, check the timer and file count, then unwrap it before the public window closes.",
  ...
  },
  {
    ...
    description:
      "If you unwrap a KandyDrop while it is live, it stays in your library after it leaves the public drops page.",
  ...
  },
  {
    ...
    label: "Return Daily",
    eyebrow: "Step 5",
    title: "Return once a day",
    description:
      "Check in, finish tasks, and refill your balance so you are ready for the next live KandyDrop.",
