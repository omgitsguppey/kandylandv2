...
interface AnalyticsResponse {
    ...
    // Firestore fields
    commerce?: { revenueUsd: number; gdSpent: number };
        ...
        <div className="pb-28 md:pb-12 min-h-screen flex flex-col pt-4">
            ...
            <header className="mb-6 sticky top-0 z-50 bg-black/80 backdrop-blur-xl pb-4 border-b border-white/5 md:border-none md:bg-transparent">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-white mb-1">Monitoring Station</h1>
                ...
                <main className="flex-1 w-full max-w-full space-y-6">
                    ...
                    {activeTab === "operations" && (
                        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="glass-panel p-6 md:p-8 rounded-[2rem] border border-white/10 relative overflow-hidden flex flex-col items-center text-center">
                                <div className="absolute top-4 right-4 flex items-center gap-2 bg-brand-purple/20 px-3 py-1 rounded-full border border-brand-purple/30">
                    ...
                    {activeTab === "commerce" && (
                        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="glass-panel p-6 md:p-8 rounded-3xl border border-[#00ffcc]/30 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#00ffcc]/10 via-black to-black">
