...
export default function DebugConsole() {
    ...
    const queueRuntimeSummary = useMemo(
        () => data?.queueRuntimeSummary || {
            ...
            liveStatusAllowed: false,
            schedulerHeartbeat: { status: "unknown", lastHeartbeatAtMs: null, expectedCadenceMs: 0, freshnessMs: null, source: "not_loaded" },
            dispatchOutcomes: { status: "unknown", outcomeCount: 0, failedCount: 0, warningCount: 0, savedDataCount: 0, savedDataStatus: "unknown", lastOutcomeAtMs: null, source: "not_loaded", sourceWindow: "not_loaded", healthProven: false, readableWhenHeartbeatMissing: true, nextAction: "Load dispatch outcome source." },
            queueDrift: { status: "source_missing", sourceLoaded: false, driftCount: 0, legacyAdapterUsageCount: 0, missingDispatchOutcomeCount: 0, blockingDriftCount: 0 },
            legacyAdapterStatus: { status: "unknown", usageCount: 0, missingDispatchOutcomeCount: 0, blockingDriftCount: 0, blocksContinuity: false, removalPolicy: "unknown", nextAction: "Load runtime warning source." },
            savedDataStatus: "unknown",
            sourceWindows: { heartbeat: "not_loaded", outcomes: "not_loaded", queueDrift: "not_loaded" },
            missingSources: ["scheduler_heartbeat", "dispatch_outcomes", "queue_drift_runtime_warnings"],
            nextAction: "Load queue runtime continuity sources before marking the lane live.",
        },
        [data?.queueRuntimeSummary],
    );
    ...
    }), [data, opsCanonicalState, systemStateMeta]);
