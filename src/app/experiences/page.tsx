...
export default function ExperiencesPage() {
    ...
    return (
        <div
            className="min-h-[calc(100dvh-11rem)] w-full overflow-hidden bg-black px-4 py-8 pb-[calc(6.5rem+env(safe-area-inset-bottom))] text-left md:min-h-[calc(100dvh-5rem)] md:py-12 md:pb-12"
