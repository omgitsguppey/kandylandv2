            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="relative flex flex-col items-center text-center group">
                        ...
                        <p className="text-gray-400">Sign up instantly with Google or Email. We'll give you <strong className="text-brand-purple">50 free Gum Drops</strong> to get started.</p>

                        <div className="hidden md:block absolute top-8 left-[60%] w-[80%] h-[2px] bg-gradient-to-r from-brand-purple/30 to-brand-purple/30" />
                    </div>
                ...
                <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto border border-white/10 rounded-3xl p-8 bg-black/40 backdrop-blur-md">
                    ...
                    <div className="text-center border-r border-white/5 md:border-r-0 lg:border-r">
                        <div className="text-3xl md:text-4xl font-black text-brand-purple mb-1">10k+</div>
                    ...
                    <div className="text-center border-r border-white/5 md:border-r">
                        <div className="text-3xl md:text-4xl font-black text-brand-purple mb-1">99%</div>
                        <div className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Creator Payout</div>
                    </div>
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-black text-brand-purple mb-1 flex items-center justify-center gap-1"><TrendingUp className="w-6 h-6" /></div>
