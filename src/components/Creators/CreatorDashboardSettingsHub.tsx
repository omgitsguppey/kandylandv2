        ...
        >
          ...
          <div className="grid gap-2.5 md:grid-cols-2" data-mobile-organization="summary-first" data-mobile-drilldown="true">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/25 p-3" data-creator-settings-section="fan-pass">
              ...
              <button type="button" disabled={isReadOnlyProjection || savingSection === "fan_pass"} aria-busy={savingSection === "fan_pass"} onClick={() => saveSettingsSection("fan_pass")} className="mt-3 min-h-11 rounded-full border border-brand-purple/25 bg-brand-purple/15 px-3 py-2 text-sm font-bold text-brand-purple disabled:opacity-60">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/25 p-3" data-creator-settings-section="broadcasts">
              ...
              <button type="button" disabled={isReadOnlyProjection || savingSection === "broadcasts"} aria-busy={savingSection === "broadcasts"} onClick={() => saveSettingsSection("broadcasts")} className="mt-3 min-h-11 rounded-full border border-brand-purple/25 bg-brand-purple/15 px-3 py-2 text-sm font-bold text-brand-purple disabled:opacity-60">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/25 p-3 md:col-span-2" data-creator-settings-section="timeline">
              ...
              <button type="button" disabled={isReadOnlyProjection || savingSection === "timeline"} aria-busy={savingSection === "timeline"} onClick={() => saveSettingsSection("timeline")} className="mt-3 min-h-11 rounded-full border border-brand-purple/25 bg-brand-purple/15 px-3 py-2 text-sm font-bold text-brand-purple disabled:opacity-60">
