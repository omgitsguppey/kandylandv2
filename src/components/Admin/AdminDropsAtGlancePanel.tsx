                                    ...
                                    >
                                        ...
                                        <div className="mt-auto flex items-center gap-1.5">
                                            <button
                                                ...
                                                aria-label="Edit" className="inline-flex h-7 items-center gap-1 rounded-full border border-white/10 bg-black/35 px-2 text-[10px] font-semibold text-white transition-colors hover:border-brand-purple/35 hover:text-brand-pink"
                                            >
                                            ...
                                            <button
                                                ...
                                                aria-label={row.isQueued ? "Unqueue" : "Queue"} className="inline-flex h-7 items-center gap-1 rounded-full border border-white/10 bg-black/35 px-2 text-[10px] font-semibold text-white transition-colors hover:border-brand-purple/35 hover:text-brand-pink disabled:opacity-60"
                                            >
