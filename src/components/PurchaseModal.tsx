...
export function PurchaseModal({ isOpen, onClose }: PurchaseModalProps) {
  ...
  useEffect(() => {
    ...
    const timeout = window.setTimeout(() => setRenderModal(false), 120);
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto pointer-events-none">
        <div className="flex min-h-full items-center justify-center p-4">
          <div className="relative w-full max-w-md bg-black/45 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-2xl border border-white/10 pointer-events-auto">
