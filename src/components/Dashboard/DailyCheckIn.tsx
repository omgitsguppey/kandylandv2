...
export function DailyCheckIn() {
    ...
    const { startOfDay: todayStartMs, endOfDay: todayEndMs } = getCSTDayBoundaries(nowMs);
    const hasClaimedToday = lastCheckInMs >= todayStartMs && lastCheckInMs < todayEndMs;

    const baseNextCheckInMs = hasClaimedToday ? todayEndMs : 0;
