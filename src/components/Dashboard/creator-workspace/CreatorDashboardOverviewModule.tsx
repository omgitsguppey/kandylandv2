...
export function CreatorDashboardOverviewModule({
    ...
    return (
        <Card
            className="rounded-2xl border-white/10 bg-black/45 !gap-0 !p-0 sm:rounded-3xl"
        ...
        >
            <div className="p-2.5 sm:p-4">
                <div className="mb-1.5 flex items-center justify-between gap-2">
                    ...
                    <Badge className="rounded-full border-white/10 bg-white/5 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-[0.12em] text-gray-200 hover:bg-white/5 sm:px-2 sm:py-1 sm:text-[10px]">
                        {overviewStatus}
                    </Badge>
                </div>
