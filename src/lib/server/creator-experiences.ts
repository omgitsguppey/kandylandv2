...
export function buildCreatorExperienceTelemetryPayload(input: {
    ...
    return {
        ...
        actorUserId: input.marker.actorType === "user" ? input.marker.actorUid ?? "" : "",
        actorCreatorId: input.marker.actorType === "creator" ? input.marker.actorUid ?? "" : "",
        actorAdminId: input.marker.actorType === "admin" || input.marker.actorType === "owner_admin" ? input.marker.actorUid ?? "" : "",
