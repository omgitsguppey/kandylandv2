...
export const GLOBAL_COST_SURFACE_CONTRACTS: GlobalCostSurfaceContract[] = [
  ...
  },
  {
    ...
    maxRuntimeMs: 10 * 60 * 1000,
    maxRetries: 0,
    cachePolicy: "materialized analytics snapshots are bounded by max event/watch/guest/feedback limits.",
    samplingPolicy: "materializers process recent bounded windows and write capped user/drop/session docs.",
    ...
    requiredKillSwitch: "dry-run/max rows/max runtime source-visible wrappers.",
    validator: "check:global-cost",
  },
  {
