...
export function normalizeTechnicalFreshnessTerms(value: string): string {
  return value
    .replace(/Operator-confirmed GumDrop revenue smoke was recorded\. Formal provider evidence is still separate\./gu, "Operator-confirmed GumDrop revenue was recorded as product context; provider-backed site activity evidence is still separate.")
    .replace(/Formal provider evidence is still separate\./gu, "Provider-backed site activity evidence is still separate.")
    .replace(/Formal provider smoke evidence is missing\./gu, "Provider-backed site activity evidence is missing.")
    .replace(/Provider smoke:\s*/gu, "Provider-backed site activity: ")
    .replace(/Runtime smoke:\s*/gu, "Deployed route evidence: ")
    .replace(/Attach formal deployed runtime\/provider smoke evidence/giu, "Produce deployed route and provider-backed site activity evidence")
    .replace(/Attach provider smoke evidence/giu, "Produce provider-backed site activity evidence")
    .replace(/Attach redacted provider smoke evidence/giu, "Produce redacted provider-backed site activity evidence")
    .replace(/formal provider smoke/giu, "provider-backed site activity")
    .replace(/formal provider proof/giu, "provider-backed site activity")
    ...
    .replace(/runtime provider smoke/giu, "provider-backed site activity and deployed route evidence")
