...
export const BEHAVIORAL_EVENT_DEDUPE_WINDOWS_MS: Record<BehavioralNormalizedAction, number | "permanent" | "event_id"> = {
  ...
  search_focused: 10 * 1000,
  search_query_changed: 2 * 1000,
  search_submitted: 10 * 1000,
  search_results_loaded: 10 * 1000,
  search_zero_results: 10 * 1000,
  search_result_clicked: 5 * 1000,
  search_failed: "event_id",
  search_cleared: 5 * 1000,
