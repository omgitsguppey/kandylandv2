...
const NORMALIZED_ACTION_FAMILY: Partial<Record<BehavioralNormalizedAction, IdentifiedMetricFamily>> = {
  ...
  task_ready: "task",
  task_guidance_viewed: "task",
  task_guidance_tapped: "task",
  task_guidance_dismissed: "task",
  task_guidance_completed: "task",
  task_card_expanded: "task",
  task_help_opened: "task",
  daily_task_started: "task",
  daily_task_action_attempted: "task",
  task_completed: "task",
  daily_task_reward_granted: "task",
  daily_task_failed: "task",
  daily_task_abandoned: "task",
  daily_task_reset_locked: "task",
  creator_spotlight_viewed: "creator",
  drop_viewed: "content",
  drop_card_viewed: "content",
  search_query_submitted: "content",
  filter_selected: "content",
  sort_changed: "content",
  category_clicked: "content",
  creator_search_selected: "creator",
  drop_preview_opened: "content",
  drop_preview_cta_clicked: "content",
  content_satisfaction_positive: "content",
  content_satisfaction_negative: "content",
  content_satisfaction_skipped: "content",
  recommendation_reason_helpful: "content",
  recommendation_reason_not_helpful: "content",
  drop_not_interested: "content",
  category_not_interested: "content",
  ...
  creator_not_interested: "creator",
  creator_muted: "creator",
