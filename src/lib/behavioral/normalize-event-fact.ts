...
const ACTION_ALIASES: Record<string, ActionAliasConfig> = {
  ...
  support_thread_opened: { normalizedAction: "chat_thread_opened", entityType: "support", entityKeys: ["thread_id", "threadId", "ticket_id", "ticketId"] },
  support_thread_replied: { normalizedAction: "chat_message_sent", entityType: "support", entityKeys: ["thread_id", "threadId", "ticket_id", "ticketId"] },
