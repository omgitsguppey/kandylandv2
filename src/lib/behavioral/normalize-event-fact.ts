...
const ACTION_ALIASES: Record<string, ActionAliasConfig> = {
  ...
  auth_surface_viewed: { normalizedAction: "signup_started", entityKeys: ["session_id", "sessionId", "anonymous_visitor_id", "anonymousVisitorId", "route"] },
  auth_google_started: { normalizedAction: "signup_started", entityKeys: ["user_id", "userId", "session_id", "sessionId", "anonymous_visitor_id", "anonymousVisitorId"] },
  auth_google_completed: { normalizedAction: "signup_completed", entityKeys: ["user_id", "userId"] },
  auth_email_login_started: { normalizedAction: "signup_started", entityKeys: ["user_id", "userId", "session_id", "sessionId", "anonymous_visitor_id", "anonymousVisitorId"] },
  auth_email_login_completed: { normalizedAction: "signup_completed", entityKeys: ["user_id", "userId"] },
  auth_email_signup_started: { normalizedAction: "signup_started", entityKeys: ["user_id", "userId", "session_id", "sessionId", "anonymous_visitor_id", "anonymousVisitorId"] },
  auth_email_signup_completed: { normalizedAction: "signup_completed", entityKeys: ["user_id", "userId"] },
  ...
  creator_discovery_surface_viewed: { normalizedAction: "creator_discovery_surface_viewed", entityType: "creator", entityKeys: ["surface", "source_component", "sourceComponent"] },
  ...
  creator_card_viewed: { normalizedAction: "creator_card_viewed", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId", "surface"] },
  creator_card_clicked: { normalizedAction: "creator_card_clicked", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId", "surface"] },
  creator_profile_opened: { normalizedAction: "creator_profile_opened", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId", "surface"] },
  ...
  search_focused: { normalizedAction: "search_focused", entityType: "search", entityKeys: ["surface", "source_component", "sourceComponent"] },
  search_query_changed: { normalizedAction: "search_query_changed", entityType: "search", entityKeys: ["query_hash", "queryHash", "query_category", "queryCategory", "normalized_query_cluster", "normalizedQueryCluster"] },
  search_submitted: { normalizedAction: "search_submitted", entityType: "search", entityKeys: ["query_hash", "queryHash", "query_category", "queryCategory", "normalized_query_cluster", "normalizedQueryCluster"] },
  search_results_loaded: { normalizedAction: "search_results_loaded", entityType: "search", entityKeys: ["query_hash", "queryHash", "query_category", "queryCategory", "result_count", "resultCount"] },
  search_zero_results: { normalizedAction: "search_zero_results", entityType: "search", entityKeys: ["query_hash", "queryHash", "query_category", "queryCategory"] },
  search_result_clicked: { normalizedAction: "search_result_clicked", entityType: "search", entityKeys: ["result_id", "resultId", "result_type", "resultType", "query_hash", "queryHash"] },
  search_failed: { normalizedAction: "search_failed", entityType: "search", entityKeys: ["failure_reason", "failureReason", "query_hash", "queryHash"] },
  search_cleared: { normalizedAction: "search_cleared", entityType: "search", entityKeys: ["surface", "source_component", "sourceComponent"] },
  ...
  drop_watch_started: { normalizedAction: "watch_session_started", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId"] },
  drop_watch_progress: { normalizedAction: "watch_session_tick", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId"] },
  drop_watch_hidden: { normalizedAction: "watch_session_tick", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId"] },
  drop_watch_replayed: { normalizedAction: "watch_session_tick", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId", "replay_count", "replayCount"] },
  drop_watch_duration_unavailable: { normalizedAction: "watch_session_tick", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId"] },
  drop_watch_abandoned: { normalizedAction: "watch_session_completed", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId"] },
  drop_watch_completed: { normalizedAction: "watch_session_completed", entityType: "drop", entityKeys: ["watch_session_id", "watchSessionId", "drop_id", "dropId", "media_id", "mediaId"] },
  ...
  creator_follow_attempted: { normalizedAction: "creator_follow_attempted", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId"] },
  creator_follow_succeeded: { normalizedAction: "creator_followed", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId"] },
  creator_followed: { normalizedAction: "creator_followed", entityType: "creator", entityKeys: ["creator_id", "creatorId"] },
  creator_follow_failed: { normalizedAction: "creator_follow_failed", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId", "failure_reason", "failureReason"] },
  creator_unfollow_attempted: { normalizedAction: "creator_unfollow_attempted", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId"] },
  creator_unfollow_succeeded: { normalizedAction: "creator_unfollowed", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId"] },
  creator_unfollowed: { normalizedAction: "creator_unfollowed", entityType: "creator", entityKeys: ["creator_id", "creatorId"] },
  creator_recommendation_viewed: { normalizedAction: "creator_recommendation_viewed", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId", "recommendation_source", "recommendationSource"] },
  creator_recommendation_clicked: { normalizedAction: "creator_recommendation_clicked", entityType: "creator", entityKeys: ["creator_id", "creatorId", "target_creator_id", "targetCreatorId", "recommendation_source", "recommendationSource"] },
  creator_relationship_list_loaded: { normalizedAction: "creator_relationship_list_loaded", entityType: "creator", entityKeys: ["surface", "source_component", "sourceComponent", "list_count", "listCount"] },
  creator_relationship_list_failed: { normalizedAction: "creator_relationship_list_failed", entityType: "creator", entityKeys: ["surface", "source_component", "sourceComponent", "failure_reason", "failureReason"] },
