...
const PANEL_SEEDS: PanelSeed[] = [
  ...
  { panelId: "gumdrop_balances", panelLabel: "GumDrop balances", panelGroup: "gumdrops", personMetricIds: ["payment_approvals", "daily_task_rewards_granted"], sourceType: "external_required", expectedSource: "wallet source ledger plus protected payment/provider evidence", sourcePath: "src/lib/math/math-authority-map.ts", materializerPath: "wallet_source_ledger", debugLane: "daily_task_reward_ledger", expectedDaily: true, costClass: "external_review" },
  ...
  { panelId: "journey_funnel", panelLabel: "Journey funnel", panelGroup: "journeys", personMetricIds: ["sessions", "drop_opens", "checkout_starts", "payment_approvals"], sourceType: "journey_summary", sourcePath: "src/app/api/admin/analytics/historical/route.ts", materializerPath: "admin_analytics_materializers:journey_funnel", debugLane: "admin_analytics_historical", expectedRecentWindow: "7d", expectedDaily: false },
