...
const PANEL_SEEDS: PanelSeed[] = [
  ...
  { panelId: "gumdrop_balances", panelLabel: "GumDrop balances", panelGroup: "gumdrops", personMetricIds: ["payment_approvals", "daily_task_rewards_granted"], sourceType: "external_required", expectedSource: "wallet source ledger plus protected payment/provider proof", sourcePath: "src/lib/math/math-authority-map.ts", materializerPath: "wallet_source_ledger", debugLane: "daily_task_reward_ledger", expectedDaily: true, costClass: "external_review" },
