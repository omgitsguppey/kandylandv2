...
export const ADMIN_AI_DROP_COVER_REFERENCE_MODEL = ADMIN_AI_DROP_COVER_MODEL;
export const ADMIN_AI_DROP_COVER_REFERENCE_LOCATION = ADMIN_AI_DROP_COVER_DEFAULT_LOCATION;
