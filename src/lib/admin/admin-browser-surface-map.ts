...
export const ADMIN_BROWSER_SURFACE_DEFINITIONS = [
  {
    ...
    sourceComponentPath: "src/app/admin/page.tsx",
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/analytics/page.tsx",
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/drops/page.tsx",
    title: "Admin Drops",
    group: "content",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
    ...
    browserSmokeReason: "Drop moderation and approval controls need source-state markers before optional browser reproduction.",
  },
  {
    surfaceId: "admin_users",
    route: "/admin/users",
    browserSmokePath: "/admin/users",
    sourceComponentPath: "src/app/admin/users/page.tsx",
    title: "Admin Users",
    group: "people",
    deviceBands: ["mobile", "desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/user/[userId]/page.tsx",
    ...
    browserSmokeReason: "User detail drilldown is identity and support sensitive; use authenticated browser reproduction only for a source-reported issue.",
  },
  {
    surfaceId: "admin_roster",
    route: "/admin/roster",
    browserSmokePath: "/admin/roster",
    sourceComponentPath: "src/app/admin/roster/page.tsx",
    title: "Admin Roster",
    group: "people",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/debug/page.tsx",
    title: "Admin Debug",
    group: "ops",
    deviceBands: ["mobile", "desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/ai/page.tsx",
    title: "Admin AI",
    group: "ops",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/support/page.tsx",
    title: "Admin Support",
    group: "ops",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/moderation/page.tsx",
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/content/page.tsx",
    title: "Admin Content",
    group: "content",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/queue/page.tsx",
    title: "Admin Queue",
    group: "content",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/privacy/page.tsx",
    title: "Admin Privacy",
    group: "ops",
    deviceBands: ["desktop"],
    requiresAdminAuth: true,
  ...
  },
  {
    ...
    sourceComponentPath: "src/app/admin/economy/page.tsx",
    title: "Admin Economy",
