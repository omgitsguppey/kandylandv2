...
export const ADMIN_COPY_REGISTRY: Record<AdminCopyPatternKey, AdminCopyPattern> = {
  analytics_delayed: {
    ...
    recommendedAction: "Check source details if the delay persists after the next refresh.",
  ...
  data_validation_moved_to_debug: {
    ...
    recommendedAction: "Keep formulas, routes, and source details in the compact drilldown.",
  ...
  fake_zero_prevented: {
    ...
    recommendedAction: "Keep the value hidden and show which source is missing.",
  ...
  technical_debug_only: {
    ...
    shortBody: "Source details need review.",
    badgeLabel: "Review",
    actionLabel: "View source details",
...
export const ADMIN_SURFACE_STATE_OPERATOR_COPY: Record<AdminSurfaceState, Pick<AdminCopyPattern, "headline" | "shortBody" | "operatorImpact" | "recommendedAction">> = {
  ...
  degraded: {
    ...
    recommendedAction: "Show the exact source detail before using this value.",
  },
  fallback: {
    headline: "Last verified data.",
    shortBody: "The live source is not the current display source.",
    operatorImpact: "The panel remains usable, but it is not live.",
    recommendedAction: "Keep showing the last verified source while the live source recovers.",
  },
  stale: {
    headline: "Last verified data.",
    shortBody: "The snapshot is older than ideal.",
    operatorImpact: "The value is usable but may lag recent activity.",
    recommendedAction: "Refresh; if the value stays delayed, keep it labeled refresh due.",
  },
  unavailable: {
  ...
  failed: {
    ...
    recommendedAction: "Show the exact failure reason before allowing action.",
  },
};
