...
export const TELEMETRY_EVENT_OPTIONS: TelemetryEventOption[] = [
  ...
  { eventName: "auth_surface_viewed", label: "Auth surface viewed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  ...
  { eventName: "auth_google_started", label: "Google sign-in started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_google_completed", label: "Google sign-in completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_google_failed", label: "Google sign-in failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_login_started", label: "Email login started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_login_completed", label: "Email login completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_login_failed", label: "Email login failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_signup_started", label: "Email signup started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_signup_completed", label: "Email signup completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_signup_failed", label: "Email signup failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  ...
  { eventName: "auth_attempt_started", label: "Auth attempt started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_attempt_succeeded", label: "Auth attempt succeeded", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_attempt_failed", label: "Auth attempt failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_attempt_unfinished", label: "Auth attempt unfinished", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_session_established", label: "Auth session established", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_registration_started", label: "Auth registration started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_registration_completed", label: "Auth registration completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_navigation_session_started", label: "Auth navigation session started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_navigation_session_completed", label: "Auth navigation session completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_navigation_session_failed", label: "Auth navigation session failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_provider_conflict_detected", label: "Auth provider conflict detected", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_provider_conflict_resolution_shown", label: "Auth provider conflict resolution shown", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_provider_conflict_cta_clicked", label: "Auth provider conflict CTA clicked", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_sign_in_failed", label: "Email sign-in failed with provider context", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_email_sign_up_failed", label: "Email sign-up failed with provider context", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_persistence_established", label: "Auth persistence established", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_state_changed", label: "Auth state changed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_unexpected_session_drop", label: "Unexpected auth session drop", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_logout_started", label: "Auth logout started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_logout_completed", label: "Auth logout completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_navigation_session_deleted", label: "Auth navigation session deleted", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_profile_bootstrap_started", label: "Auth profile bootstrap started", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_profile_bootstrap_completed", label: "Auth profile bootstrap completed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_profile_bootstrap_failed", label: "Auth profile bootstrap failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_profile_snapshot_reconnect", label: "Auth profile snapshot reconnect", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_profile_snapshot_failed", label: "Auth profile snapshot failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  ...
  { eventName: "auth_password_reset_requested", label: "Auth password reset requested", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  { eventName: "auth_password_reset_failed", label: "Auth password reset failed", category: "auth", sources: DEFAULT_CLIENT_SOURCES, modules: ["auth"] },
  ...
  { eventName: "homepage_hero_viewed", label: "Homepage hero viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "navigation"] },
  { eventName: "homepage_live_chip_viewed", label: "Homepage live chip viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "navigation", "content"] },
  ...
  { eventName: "drop_preview_opened", label: "Drop preview opened", category: "content", sources: DEFAULT_CLIENT_SOURCES, modules: ["content"], aliases: ["drop_preview"] },
  ...
  { eventName: "drop_view_access_allowed_unwrapped", label: "Drop view access allowed by unwrap", category: "content", sources: DEFAULT_CLIENT_SOURCES, modules: ["viewer", "content"] },
  { eventName: "drop_view_access_denied_not_unwrapped", label: "Drop view access denied not unwrapped", category: "content", sources: DEFAULT_CLIENT_SOURCES, modules: ["viewer", "content"] },
  { eventName: "drop_view_access_loading_timeout", label: "Drop view access loading timeout", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["viewer", "runtime"] },
  { eventName: "drop_view_access_error", label: "Drop view access error", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["viewer", "runtime"] },
  ...
  { eventName: "creator_rail_impression", label: "Creator rail impression", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "engagement", "navigation"], aliases: ["creator_spotlight_viewed"] },
    ...
    { eventName: "admin_creator_monetization_summary_viewed", label: "Admin creator monetization summary viewed", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin", "creator", "commerce"] },
    { eventName: "admin_creator_monetization_issue_opened", label: "Admin creator monetization issue opened", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin", "creator", "commerce"] },
    { eventName: "creator_monetization_mismatch_reviewed", label: "Creator monetization mismatch reviewed", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin", "creator", "commerce"] },
    { eventName: "creator_drop_manager_viewed", label: "Creator drop manager viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_draft_created", label: "Creator drop draft created", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_draft_saved", label: "Creator drop draft saved", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_submit_attempted", label: "Creator drop submit attempted", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_submit_succeeded", label: "Creator drop submit succeeded", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_submit_failed", label: "Creator drop submit failed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_pending_review_viewed", label: "Creator drop pending review viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    { eventName: "creator_drop_status_viewed", label: "Creator drop status viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "content"] },
    ...
    { eventName: "admin_creator_drop_review_viewed", label: "Admin creator drop review viewed", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin", "creator", "content"] },
    { eventName: "admin_creator_drop_approved", label: "Admin creator drop approved", category: "admin", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["admin", "creator", "content"] },
    { eventName: "admin_creator_drop_rejected", label: "Admin creator drop rejected", category: "admin", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["admin", "creator", "content"] },
    { eventName: "admin_creator_drop_needs_changes", label: "Admin creator drop needs changes", category: "admin", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["admin", "creator", "content"] },
    { eventName: "admin_creator_drop_review_failed", label: "Admin creator drop review failed", category: "admin", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["admin", "creator", "content"] },
  ...
  { eventName: "media_upload_prepare_started", label: "Media upload prepare started", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_prepare_completed", label: "Media upload prepare completed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_prepare_failed", label: "Media upload prepare failed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_storage_upload_started", label: "Media storage upload started", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_storage_upload_completed", label: "Media storage upload completed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_storage_upload_failed", label: "Media storage upload failed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_complete_started", label: "Media upload complete started", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_complete_completed", label: "Media upload complete completed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_complete_failed", label: "Media upload complete failed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_cancelled", label: "Media upload cancelled", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_orphaned", label: "Media upload orphaned", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_recovered", label: "Media upload recovered", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "runtime"] },
  { eventName: "media_upload_blocked_size", label: "Media upload blocked by size", category: "security", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "security"] },
  { eventName: "media_upload_blocked_type", label: "Media upload blocked by type", category: "security", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "security"] },
  { eventName: "media_access_allowed", label: "Private media access allowed", category: "security", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["content", "security", "viewer"] },
  { eventName: "media_access_blocked", label: "Private media access blocked", category: "security", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["content", "security", "viewer"] },
  { eventName: "media_access_failed", label: "Private media access failed", category: "security", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["content", "security", "runtime"] },
  { eventName: "media_asset_missing", label: "Private media asset missing", category: "security", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["content", "security", "runtime"] },
  { eventName: "media_expired_blocked", label: "Expired private media blocked", category: "security", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["content", "security", "viewer"] },
  ...
  { eventName: "chat_media_file_allowed_fan_pass", label: "Chat media file allowed by fan pass", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement"] },
  { eventName: "chat_icebreaker_inserted", label: "Chat ice breaker inserted", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement"] },
  { eventName: "chat_empty_state_viewed", label: "Chat empty state viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement"] },
  ...
  { eventName: "fan_pass_surface_viewed", label: "Fan Pass surface viewed", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "engagement"] },
  { eventName: "fan_pass_cta_clicked", label: "Fan Pass CTA clicked", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["creator", "engagement"] },
  { eventName: "fan_pass_purchase_attempted", label: "Fan Pass purchase attempted", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  { eventName: "fan_pass_purchase_succeeded", label: "Fan Pass purchase succeeded", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  { eventName: "fan_pass_purchase_failed", label: "Fan Pass purchase failed", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  { eventName: "fan_pass_access_granted", label: "Fan Pass access granted", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  { eventName: "fan_pass_access_denied", label: "Fan Pass access denied", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  { eventName: "fan_pass_cancelled", label: "Fan Pass cancelled", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  { eventName: "fan_pass_expired", label: "Fan Pass expired", category: "commerce", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "commerce"] },
  ...
  { eventName: "notification_prompt_eligible", label: "Notification prompt eligible", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "notification_prompt_viewed", label: "Notification prompt viewed", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"], aliases: ["notification_prompt_banner_viewed", "notification_prompted"] },
  { eventName: "notification_prompt_dismissed", label: "Notification prompt dismissed", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"], aliases: ["notification_prompt_banner_dismissed"] },
  { eventName: "notification_permission_requested", label: "Notification permission requested", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "notification_permission_granted", label: "Notification permission granted", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"], aliases: ["notification_enabled"] },
  { eventName: "notification_permission_denied", label: "Notification permission denied", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "notification_permission_failed", label: "Notification permission failed", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "notification_prompt_snoozed", label: "Notification prompt snoozed", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "notification_prompt_blocked", label: "Notification prompt blocked", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  ...
  { eventName: "push_token_registration_started", label: "Push token registration started", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "push_token_registered", label: "Push token registered", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  { eventName: "push_token_registration_failed", label: "Push token registration failed", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  { eventName: "push_token_refreshed", label: "Push token refreshed", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  { eventName: "push_token_revoked", label: "Push token revoked", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  { eventName: "push_device_scope_resolved", label: "Push device scope resolved", category: "notifications", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications"] },
  { eventName: "pwa_service_worker_registration_started", label: "PWA service worker registration started", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_service_worker_registered", label: "PWA service worker registered", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_service_worker_registration_failed", label: "PWA service worker registration failed", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_update_available", label: "PWA update available", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_update_applied", label: "PWA update applied", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_offline_seen", label: "PWA offline fallback seen", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_install_prompt_seen", label: "PWA install prompt seen", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_install_prompt_accepted", label: "PWA install prompt accepted", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "pwa_install_prompt_dismissed", label: "PWA install prompt dismissed", category: "system", sources: DEFAULT_CLIENT_SOURCES, modules: ["notifications", "runtime"] },
  { eventName: "notification_intent_evaluated", label: "Notification intent evaluated", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  { eventName: "notification_targeting_blocked", label: "Notification targeting blocked", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  { eventName: "notification_targeting_dry_run_eligible", label: "Notification targeting dry-run eligible", category: "notifications", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["notifications"] },
  ...
  { eventName: "daily_task_surface_viewed", label: "Daily task surface viewed", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks"] },
  { eventName: "daily_task_card_viewed", label: "Daily task card viewed", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks"] },
  { eventName: "daily_task_guidance_opened", label: "Daily task guidance opened", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks", "task_guidance"] },
  ...
  { eventName: "daily_task_action_attempted", label: "Daily task action attempted", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks"] },
  ...
  { eventName: "daily_task_reward_granted", label: "Daily task reward granted", category: "tasks", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["tasks"] },
  ...
  { eventName: "daily_task_abandoned", label: "Daily task abandoned", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks"] },
  { eventName: "daily_task_reset_locked", label: "Daily task reset locked", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks"] },
  { eventName: "daily_task_next_eligible_viewed", label: "Daily task next eligible viewed", category: "tasks", sources: DEFAULT_CLIENT_SOURCES, modules: ["tasks"] },
  ...
  { eventName: "asset_upload_queued", label: "Asset upload queued", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_selected", label: "Asset batch selected", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_queue_started", label: "Asset batch queue started", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_progress_updated", label: "Asset batch progress updated", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_completed", label: "Asset batch completed", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_failed", label: "Asset batch failed", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_retry_failed_clicked", label: "Asset batch retry failed clicked", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_batch_submit_blocked_uploads_in_progress", label: "Asset batch submit blocked uploads in progress", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_upload_progress_checkpoint", label: "Asset upload progress checkpoint", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  ...
  { eventName: "asset_upload_retry_clicked", label: "Asset upload retry clicked", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  { eventName: "asset_upload_canceled", label: "Asset upload canceled", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin"] },
  ...
  { eventName: "admin_ai_cover_history_cleared", label: "Admin AI cover history cleared", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin", "content"] },
  ...
  { eventName: "admin_ai_description_history_cleared", label: "Admin AI description history cleared", category: "admin", sources: DEFAULT_CLIENT_SOURCES, modules: ["admin", "content"] },
