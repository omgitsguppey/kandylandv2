...
export const TELEMETRY_EVENT_OPTIONS: TelemetryEventOption[] = [
  ...
  { eventName: "creator_legally_cleared", label: "Creator legally cleared", category: "admin", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "admin", "onboarding"] },
