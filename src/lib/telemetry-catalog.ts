...
export const TELEMETRY_EVENT_OPTIONS: TelemetryEventOption[] = [
  ...
  { eventName: "creator_favorited", label: "Creator favorited", category: "engagement", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "engagement"] },
  { eventName: "creator_unfavorited", label: "Creator unfavorited", category: "engagement", sources: DEFAULT_CANONICAL_SERVER_SOURCES, modules: ["creator", "engagement"] },
