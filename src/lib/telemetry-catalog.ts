...
export const TELEMETRY_EVENT_OPTIONS: TelemetryEventOption[] = [
  ...
  { eventName: "drops_category_selected", label: "Drops category selected", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "content"] },
  { eventName: "drops_searched", label: "Drops searched", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "content"] },
  { eventName: "library_search", label: "Library search", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["engagement", "content"] },
  ...
  { eventName: "unlock_drop_failed", label: "Unlock drop failed", category: "content", sources: DEFAULT_CLIENT_SOURCES, modules: ["content"] },
  { eventName: "viewer_feedback_submitted", label: "Viewer feedback submitted", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["viewer", "engagement"] },
