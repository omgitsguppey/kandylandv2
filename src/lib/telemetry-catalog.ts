...
export const TELEMETRY_EVENT_OPTIONS: TelemetryEventOption[] = [
  ...
  { eventName: "onboarding_friction", label: "Onboarding friction", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["onboarding"] },
  { eventName: "auth_onboarding_friction", label: "Auth onboarding friction", category: "engagement", sources: DEFAULT_CLIENT_SOURCES, modules: ["onboarding", "auth"] },
