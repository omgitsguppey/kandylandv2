...
export const BUILT_IN_DAILY_TASKS: DailyTaskDefinition[] = [
  ...
  createTask({
    id: "revisit_live_drops",
    title: "Circle back to live drops",
    subtitle: "Open Drops twice and stay close to what is live.",
    reward: 80,
    maxProgress: 2,
  ...
  createTask({
    id: "revisit_experiences_hub",
    title: "Check Experiences twice",
    subtitle: "Keep the daily loop warm by revisiting Experiences.",
    reward: 90,
    maxProgress: 2,
    eventName: "experience_hub_viewed",
    actionType: "open_experiences",
  ...
  createTask({
    id: "revisit_library_hub",
    title: "Open your library twice",
    subtitle: "Keep your unlocked stash top of mind.",
    reward: 100,
    maxProgress: 2,
    eventName: "library_viewed",
    actionType: "open_library",
  ...
  createTask({
    id: "scout_four_drops",
    title: "Scout 4 live drops",
    subtitle: "Preview more KandyDrops before the best ones disappear.",
    reward: 240,
    maxProgress: 4,
    eventName: "drop_preview_opened",
    actionType: "open_drops",
  ...
  createTask({
    id: "inspect_six_drop_details",
    title: "Inspect 6 drop details",
    subtitle: "Open detail views and hunt for your next favorite.",
    reward: 280,
    maxProgress: 6,
    eventName: "view_drop_details",
    actionType: "open_drops",
  ...
  createTask({
    id: "unwrap_three_drops",
    title: "Unwrap 3 KandyDrops",
    subtitle: "Go deeper and build a real streak of unwrapped content.",
    reward: 780,
    maxProgress: 3,
    eventName: "unlock_drop_success",
    actionType: "open_drops",
  ...
  createTask({
    id: "unwrap_four_drops",
    title: "Unwrap 4 KandyDrops",
    subtitle: "Stack up a bigger haul before the timer runs out.",
    reward: 1000,
    maxProgress: 4,
    eventName: "unlock_drop_success",
    actionType: "open_drops",
  ...
  createTask({
    id: "unwrap_sweet_drop",
    title: "Unwrap a Sweet drop",
    subtitle: "Find a softer flavor and add it to your stash.",
    reward: 360,
    maxProgress: 1,
    eventName: "unlock_drop_success",
    actionType: "open_drops",
  ...
  createTask({
    id: "unwrap_raw_drop",
    title: "Unwrap a RAW drop",
    subtitle: "Go straight for the most exclusive side of the catalog.",
    reward: 420,
    maxProgress: 1,
    eventName: "unlock_drop_success",
    actionType: "open_drops",
  ...
  createTask({
    id: "open_two_unwrapped_drops",
    title: "Open 2 unwrapped drops",
    subtitle: "Come back to your library and keep your unlocks alive.",
    reward: 260,
    maxProgress: 2,
    eventName: "viewer_opened",
    actionType: "open_library",
  ...
  createTask({
    id: "complete_one_viewer_session",
    title: "Finish 1 viewing session",
    subtitle: "Stay with one unlock long enough to finish the moment.",
    reward: 320,
    maxProgress: 1,
  ...
  createTask({
    id: "complete_two_viewer_sessions",
    title: "Finish 2 viewing sessions",
    subtitle: "Give two different drops your full attention today.",
    reward: 620,
    maxProgress: 2,
    eventName: "viewer_session_completed",
    actionType: "open_library",
  ...
  createTask({
    id: "watch_two_full_minutes",
    title: "Watch for 2 full minutes",
    subtitle: "Stick with your unlocked content a little longer.",
    reward: 520,
    maxProgress: 1,
    eventName: "viewer_session_completed",
    actionType: "open_library",
  ...
  createTask({
    id: "finish_two_files",
    title: "Finish 2 unlocked files",
    subtitle: "Watch all the way through on two separate files.",
    reward: 340,
    maxProgress: 2,
  ...
  createTask({
    id: "finish_four_files",
    title: "Finish 4 unlocked files",
    subtitle: "Go for a bigger binge across your library.",
    reward: 720,
    maxProgress: 4,
    eventName: "viewer_asset_completed",
    actionType: "open_library",
  ...
  createTask({
    id: "watch_three_unwrapped_files",
    title: "Watch 3 unwrapped files",
    subtitle: "Keep the momentum going across more of your unlocks.",
    reward: 390,
    maxProgress: 3,
    eventName: "viewer_asset_consumed",
    actionType: "open_library",
  ...
  createTask({
    id: "hit_forty_five_seconds",
    title: "Stay for 45 seconds",
    subtitle: "Give one unlocked file a real watch, not just a glance.",
    reward: 280,
    maxProgress: 1,
    eventName: "viewer_watch_checkpoint",
    actionType: "open_library",
  ...
  createTask({
    id: "download_one_unwrapped_file",
    title: "Download 1 unlocked file",
    subtitle: "Save one favorite so it is ready when you want it again.",
    reward: 180,
    maxProgress: 1,
  ...
  createTask({
    id: "chase_a_related_drop",
    title: "Follow a related drop",
    subtitle: "Jump from one unlock into the next recommendation.",
    reward: 150,
    maxProgress: 1,
    ...
    icon: "sparkles",
    group: "watch",
    uniqueByParamKey: "destination",
  }),
  createTask({
    id: "open_a_notification_update",
    title: "Open a fresh notification",
    subtitle: "Tap into an alert and come back for what is new.",
    reward: 90,
    maxProgress: 1,
