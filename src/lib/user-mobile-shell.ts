...
export const CHAT_LIST_CONTROLS_BOTTOM_OFFSET = USER_MOBILE_CHAT_BOTTOM_NAV_SAFE_OFFSET;
...
export const CHAT_THREAD_COMPOSER_PADDING_BOTTOM = USER_MOBILE_CHAT_BOTTOM_NAV_SAFE_OFFSET;
