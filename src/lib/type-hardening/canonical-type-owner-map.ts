...
export const CANONICAL_TYPE_OWNER_MAP: CanonicalTypeOwnerEntry[] = [
  ...
  },
  {
    ...
    adapterFiles: ["src/lib/generated-reports/generated-report-contract.ts"],
  ...
  },
  {
    ...
    canonicalFiles: ["src/lib/features/feature-registration-contract.ts", "src/lib/parity/surface-parity-contract.ts", "src/lib/telemetry/surface-telemetry-contract.ts"],
