...
const BUG_REPORT_CONTEXT_REGISTRY: Record<string, BugReportComponentMeta> = {
  ...
  "drop-preview-locked": {
    ...
    componentName: "LockedDropPreviewClient",
    sourcePath: "src/components/Drops/LockedDropPreviewClient.tsx",
    routeHint: "/drops/[id]/preview",
  ...
  "drop-preview-page": {
    contextId: "drop-preview-page",
    title: "Drop preview page",
    componentName: "LockedDropPreviewClient",
    sourcePath: "src/components/Drops/LockedDropPreviewClient.tsx",
    routeHint: "/drops/[id]/preview",
    codeSnippet: "<ReportBugButton context=\"drop-preview-page\" />",
  },
  "wallet-success": {
