...
export const PUBLIC_RELEASE_NOTES_FALLBACK = {
  ...
  "notes": [
    ...
    },
    {
      ...
      "previousBetaReleaseCounter": 482,
      "commitSha": "pending-same-commit",
      "commitTitle": "docs(beta): repair freshness window",
      "commitCount": 1,
      "commitShas": [
        "pending-same-commit"
      ],
      "committedAt": "2026-05-26T04:15:00.000Z",
      "generatedAt": "2026-05-26T04:15:00.000Z",
      "committedAtUtc": "2026-05-26T04:15:00.000Z",
      "generatedAtUtc": "2026-05-26T04:15:00.000Z",
      "category": "Improved",
      "title": "Freshness window repair",
      "updatedAtUtc": "2026-05-26T04:15:00.000Z",
      "summary": "Refreshed stale required beta evidence reports.",
      "userFacingTitle": "Freshness window repair",
      "surfaceCategory": "App experience",
      "bullets": [
      ...
      "audience": "all",
      "technicalDetails": [
        "Updated beta score freshness inputs so current lock artifacts own superseded parity, feature connection, and creator cost lanes.",
        "Added a freshness-window repair validator, generated evidence report, and unit coverage for stale report classification.",
        "Preserved formal manual, provider, runtime, and admin truth gates without production reads, provider calls, payment runtime changes, or GumDrop math changes."
      ],
      "affectedSurfaces": [
        "Public beta score evidence",
        "Freshness repair evidence",
      ...
      "changedFiles": [
        ...
        "scripts/agent/validate-freshness-window-repair.ts",
        "src/lib/release-notes/public-release-notes.ts",
        "src/lib/release-notes/release-version-contract.ts",
        "tests/unit/freshness-window-repair.spec.ts"
      ],
    ...
    {
      "version": "1.4.82",
      "previousVersion": "1.4.81",
      "betaReleaseCounter": 482,
      "previousBetaReleaseCounter": 481,
      "commitSha": "pending-same-commit",
      "commitTitle": "fix(beta): repair targeted behavior evidence",
      "commitCount": 1,
      "commitShas": [
        "pending-same-commit"
      ],
      "committedAt": "2026-05-26T04:05:00.000Z",
      "generatedAt": "2026-05-26T04:05:00.000Z",
      "committedAtUtc": "2026-05-26T04:05:00.000Z",
      "generatedAtUtc": "2026-05-26T04:05:00.000Z",
      "category": "Improved",
      "title": "Targeted behavior evidence repair",
      "updatedAtUtc": "2026-05-26T04:05:00.000Z",
      "summary": "Repaired targeted behavior evidence using current validators.",
      "userFacingTitle": "Targeted behavior evidence repair",
      "surfaceCategory": "App experience",
      "bullets": [
      ...
      "audience": "all",
      "technicalDetails": [
        "Replaced obsolete targeted behavior validator inputs with current lock validators for parity, media/discovery, creator monetization, auth, notifications, tasks, chat, telemetry, feature registration, activity verification, event translation, person metrics, state parity, and role parity lanes.",
        "Added a targeted behavior evidence repair validator, source-only report, and unit coverage that fails on missing limitations, unclassified dirty files, or source evidence clearing formal gates.",
        "Refreshed targeted behavior evidence and beta score artifacts without production reads, provider calls, runtime smoke, admin production samples, payment runtime changes, or GumDrop math changes."
      ],
      "affectedSurfaces": [
        "Public beta score evidence",
        "Targeted behavior evidence",
        "Validator inventory",
        "Feature registration evidence",
      ...
      "changedFiles": [
        ...
        "src/lib/release-notes/public-release-notes.ts",
        "src/lib/release-notes/release-version-contract.ts",
        "tests/unit/targeted-behavior-evidence-repair.spec.ts"
      ],
    ...
    },
    {
      ...
      "previousBetaReleaseCounter": 479,
      "commitSha": "pending-same-commit",
      "commitTitle": "fix(admin): add creator monetization debug",
      "commitCount": 1,
      "commitShas": [
        "pending-same-commit"
      ],
      "committedAt": "2026-05-26T03:05:00.000Z",
      "generatedAt": "2026-05-26T03:05:00.000Z",
      "committedAtUtc": "2026-05-26T03:05:00.000Z",
      "generatedAtUtc": "2026-05-26T03:05:00.000Z",
      "category": "Improved",
      "title": "Creator monetization diagnostics",
      "updatedAtUtc": "2026-05-26T03:05:00.000Z",
      "summary": "Connected creator monetization and entitlement health to admin debug.",
      "userFacingTitle": "Creator monetization diagnostics",
      "surfaceCategory": "Creator tools",
      "bullets": [
      ...
      "audience": "creators",
      "technicalDetails": [
        "Added a creator monetization admin debug contract, route summary wiring, and source-only validation lane.",
        "Mapped Fan Pass, creator entitlement, paid chat, access denial, and source-of-funds mismatch health into compact admin debug evidence.",
        "Kept provider payloads, private user identifiers, payment runtime, and GumDrop math out of the summary path."
      ],
      "affectedSurfaces": [
        "Admin Debug Control Tower",
        "Creator monetization debug evidence",
        "Fan Pass admin summary",
        "Creator entitlement and chat pricing diagnostics"
      ],
      "hiddenFromPublic": false,
      "changedFiles": [
        "CHANGELOG.md",
        "agent/state/creator-monetization-admin-debug.generated.json",
        "agent/state/public-beta-score.generated.json",
        "docs/agent-truth/creator-monetization-admin-debug.md",
        "package.json",
        "public/kandydrops-release-notes.json",
        "scripts/agent/validate-creator-monetization-admin-debug.ts",
        "src/app/api/admin/debug/route.ts",
        "src/lib/admin/creator-monetization-debug-contract.ts",
        "src/lib/release-notes/public-release-notes.ts",
        "src/lib/release-notes/release-version-contract.ts",
        "src/lib/telemetry-catalog.ts",
        "tests/unit/creator-monetization-admin-debug.spec.ts"
      ],
      "effectiveChangeCount": 13,
      "excludedGeneratedChangeCount": 2,
      "bumpType": "patch",
    ...
    {
      "version": "1.4.76",
      "previousVersion": "1.4.75",
      "betaReleaseCounter": 476,
      "previousBetaReleaseCounter": 475,
      "commitSha": "pending-same-commit",
      "commitTitle": "docs(discovery): lock media discovery",
      "commitCount": 1,
      "commitShas": [
        "pending-same-commit"
      ],
      "committedAt": "2026-05-25T23:29:04.159Z",
      "generatedAt": "2026-05-25T23:29:04.159Z",
      "committedAtUtc": "2026-05-25T23:29:04.159Z",
      "generatedAtUtc": "2026-05-25T23:29:04.159Z",
      "category": "Improved",
      "title": "Media discovery score lock",
      "updatedAtUtc": "2026-05-25T23:29:04.159Z",
      "summary": "Locked media upload, private access, creator discovery, and search telemetry readiness.",
      "userFacingTitle": "Media discovery score lock",
      "surfaceCategory": "App experience",
      "bullets": [
      ...
      "audience": "all",
      "technicalDetails": [
        "Added a final source-only media discovery score lock validator and generated evidence report without production reads or provider calls.",
        "Verified existing media upload, private media access, creator relationship, and search discovery phase artifacts as the active evidence chain.",
        "Checked redacted media/search telemetry, debug lanes, sensitive route access state, score dimensions, and dirty-file boundaries."
      ],
      "affectedSurfaces": [
        "Media upload lifecycle",
        "Private media access",
        "Creator discovery and relationships",
        "Search discovery telemetry",
        "Debug and score evidence"
      ],
      "hiddenFromPublic": false,
      "changedFiles": [
        "CHANGELOG.md",
        ...
        "src/lib/release-notes/public-release-notes.ts",
        "src/lib/release-notes/release-version-contract.ts",
        "tests/unit/media-discovery-score-lock.spec.ts"
      ],
      "effectiveChangeCount": 9,
    ...
    },
    {
      ...
      "previousBetaReleaseCounter": 468,
      "commitSha": "pending-same-commit",
      "commitTitle": "fix(parity): standardize surface states",
      "commitCount": 1,
      "commitShas": [
        "pending-same-commit"
      ],
      "committedAt": "2026-05-25T21:23:58.219Z",
      "generatedAt": "2026-05-25T21:23:58.219Z",
      "committedAtUtc": "2026-05-25T21:23:58.219Z",
      "generatedAtUtc": "2026-05-25T21:23:58.219Z",
      "category": "Improved",
      "title": "Surface state parity",
      "updatedAtUtc": "2026-05-25T21:23:58.219Z",
      "summary": "Standardized loading, empty, error, degraded, and permission states across surfaces.",
      "userFacingTitle": "Surface state parity",
      "surfaceCategory": "App experience",
      "bullets": [
      ...
      "audience": "all",
      "technicalDetails": [
        "Added a canonical surface state contract and resolver for loading, empty, ready, degraded, error, permission_denied, not_configured, locked, unavailable, and stale states.",
        "Mapped surface states to the Phase 2 surface telemetry spine and Surface state parity debug lane.",
        "Added source-only validation for raw developer-facing state copy, endless loading risk, missing CTAs, and state score evidence."
      ],
      "affectedSurfaces": [
        "Public, user, creator, and admin surface states",
        "Surface telemetry and debug evidence",
        "State parity validator and generated report"
      ],
      "hiddenFromPublic": false,
      "changedFiles": [
        "src/lib/parity/surface-state-contract.ts",
        "src/lib/parity/surface-state-resolver.ts",
        "scripts/agent/validate-surface-state-parity.ts",
    ...
    },
    {
      ...
      "previousBetaReleaseCounter": 461,
      "commitSha": "pending-same-commit",
      "commitTitle": "fix(analytics): repair unlock watch parity",
      "commitCount": 1,
      "commitShas": [
        "pending-same-commit"
      ],
      "committedAt": "2026-05-25T07:12:37.000Z",
      "generatedAt": "2026-05-25T07:12:37.000Z",
      "committedAtUtc": "2026-05-25T07:12:37.000Z",
      "generatedAtUtc": "2026-05-25T07:12:37.000Z",
      "category": "Fixed",
      "title": "Unlock and watch parity repair",
      "updatedAtUtc": "2026-05-25T07:12:37.000Z",
      "summary": "Repaired unlock, viewer start, and watch capture parity so transactions, server telemetry, rollups, session facts, and journey metrics report exact source reasons.",
      "userFacingTitle": "Unlock and watch parity repair",
      "surfaceCategory": "Drops & viewer",
      "bullets": [
      ...
      "audience": "all",
      "technicalDetails": [
        "Successful unlocks now build deterministic canonical server unlock telemetry with transaction, entitlement, drop, user, and spend source linkage.",
        "Viewer watch-session starts now emit a canonical viewer start event after entitlement checks; historical missing events remain explicit blockers without production backfill."
      ],
      "affectedSurfaces": [
        "Drops unlock telemetry",
        "Viewer watch-session telemetry",
      ...
      "changedFiles": [
        ...
        "src/lib/commerce/unlock-rollup-reconciliation.ts",
        "src/lib/analytics/viewer-start-telemetry-contract.ts",
        "src/lib/analytics/watch-capture-quality-contract.ts",
        "src/lib/analytics/watch-session-fact-linker.ts",
        "src/lib/behavioral/unlock-watch-journey-normalization.ts"
      ],
