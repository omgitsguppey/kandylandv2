...
try {
  ...
  const allowedPatterns = [
    ...
    /^src\/lib\/debug\/debug-backlog-builder\.ts$/u,
    ...
    /^tests\/unit\/admin-analytics-commerce-mobile\.spec\.ts$/u,
    ...
    /^tests\/unit\/analytics-panel-hydration\.spec\.ts$/u,
    ...
    /^tests\/unit\/debug-backlog-engine\.spec\.ts$/u,
    ...
    /^agent\/state\/generated-report-authority\.generated\.json$/u,
    /^agent\/state\/source-agreement-failure-detail\.generated\.json$/u,
    /^agent\/state\/debug-cockpit-batch29-analytics-source-hierarchy\.generated\.json$/u,
    /^agent\/state\/admin-analytics-realtime-dependency-audit\.generated\.json$/u,
    /^agent\/state\/admin-analytics-realtime-hot-cache\.generated\.json$/u,
    ...
    /^docs\/agent-truth\/debug-cockpit-batch29-analytics-source-hierarchy\.md$/u,
    /^docs\/agent-truth\/admin-analytics-realtime-hot-cache\.md$/u,
    /^docs\/agent-truth\/admin-analytics-realtime-to-hot-cache-audit\.md$/u,
    ...
    /^scripts\/agent\/validate-admin-debug-control-tower\.ts$/u,
    /^scripts\/agent\/debug-cockpit-batch29-analytics-source-hierarchy-shared\.ts$/u,
    /^scripts\/agent\/validate-source-agreement-failure-detail\.ts$/u,
    /^src\/lib\/release-readiness\/automated-truth-reconciliation\.ts$/u,
