...
try {
  ...
  const allowedPatterns = [
    ...
    /^src\/lib\/analytics\/analytics-source-agreement-status\.ts$/u,
    ...
    /^scripts\/agent\/validate-analytics-source-agreement-cleanup\.ts$/u,
    ...
    /^tests\/unit\/analytics-source-agreement-cleanup\.spec\.ts$/u,
    ...
    /^agent\/state\/analytics-source-agreement-cleanup\.generated\.json$/u,
    ...
    /^docs\/agent-truth\/analytics-source-agreement-cleanup\.md$/u,
