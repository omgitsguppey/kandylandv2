...
function renderDoc(report: RealUsageConfidenceCalibrationReport) {
  return [
    ...
    `- Provider-backed site activity evidence cleared: ${report.formalGateImpact.clearsFormalProvider}`,
    `- Deployed route evidence cleared: ${report.formalGateImpact.clearsDeployedRuntime}`,
