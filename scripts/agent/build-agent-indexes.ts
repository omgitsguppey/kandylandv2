...
const SURFACES = [
  ...
  ["ai_admin", ["src/app/admin/ai", "src/app/api/admin/ai", "src/lib/ai-", "src/lib/server/ai-"], "high", false, ["npm run test:contracts", "npm run check:ui:audits"], ["ai_admin_runtime_helpers", "runtime_health_admin_debug_observability"], ["route_runtime_health", "server_diagnostics", "admin_panel_system_logs"], [], ["Keep AI runtime truth aligned with shared registries."]],
