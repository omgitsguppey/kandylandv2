...
function classifyDirtyFile(path: string) {
  ...
  if (normalized === "agent/state/source-backed-runtime-confidence.generated.json") return "current_generated_artifact_to_commit";
  ...
  if (normalized === "docs/agent-truth/source-backed-runtime-confidence.md") return "documentation_artifact_expected";
  ...
  if (normalized === "scripts/agent/validate-source-backed-runtime-confidence.ts") return "validator_artifact_expected";
  ...
  if (normalized === "tests/unit/source-backed-runtime-confidence.spec.ts") return "test_artifact_expected";
