...
const surfaceValidators: Record<string, string[]> = {
  ...
  "admin-debug": ["check:admin-debug-control-tower", "check:debug-evidence-pipeline", "check:admin-truth"],
  "admin-ai": ["check:admin-debug-control-tower", "check:admin-review-badges", "check:google-cost"],
