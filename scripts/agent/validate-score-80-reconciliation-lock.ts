...
function renderDoc(report: Score80ReconciliationLockReport) {
  ...
  return [
    ...
    `- Clears provider-backed site activity: ${report.formalGateImpact.clearsFormalProvider}`,
    `- Clears admin source sample: ${report.formalGateImpact.clearsFormalAdminTruth}`,
    "",
