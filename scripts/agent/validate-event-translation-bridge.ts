...
function findActiveOldLogic() {
  ...
  return trackedFiles().filter((path) => {
    ...
    if (path === "agent/state/evidence-capture-status.generated.json") return false;
    ...
    if (path === "agent/state/overnight-beta-readiness-lock.generated.json") return false;
    if (path === "docs/agent-truth/overnight-beta-readiness-lock.md") return false;
    if (path === "docs/agent-truth/evidence-capture-status.md") return false;
    ...
    if (path === "scripts/agent/validate-overnight-beta-readiness-lock.ts") return false;
    if (path === "scripts/agent/validate-evidence-capture-status.ts") return false;
    ...
    if (path === "src/lib/admin-analytics/panel-hydration-registry.ts") return false;
    if (path === "src/lib/admin-analytics/panel-hydration-resolver.ts") return false;
    if (path === "src/lib/release-readiness/live-panel-evidence-resolver.ts") return false;
    ...
    if (path === "agent/state/person-metrics-hydration.generated.json") return false;
