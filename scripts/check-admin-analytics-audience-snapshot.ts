...
assertIncludes("audience helper", helper, "buildGuestTrafficRecoveryMetricState");
assertIncludes("audience helper", helper, "canonicalSourceTruth");
assertIncludes("audience helper", helper, "sourceFreshnessState");
assertIncludes("audience helper", helper, "lateArrivalWindowDays");
assertIncludes("audience helper", helper, "missingVsZeroState");
