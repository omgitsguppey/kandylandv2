...
assertIncludes("useAdminAnalyticsState", hook, "Source: server-confirmed transactions");
assertIncludes("useAdminAnalyticsState", hook, "Source: completed transactions");
...
assertIncludes("device mix helper", deviceMixHelper, "\"ga4_evidence_only\"");
assertNotIncludes("device mix helper", deviceMixHelper, 'fallbackSourceTruth: response ? "ga4"');
assertIncludes("top paths helper", topPathsHelper, "buildAdminAnalyticsTopPathsModel");
assertIncludes("top paths helper", topPathsHelper, "\"ga4_evidence_only\"");
assertNotIncludes("top paths helper", topPathsHelper, 'fallbackSourceTruth: response ? "ga4"');
...
assertNotIncludes("audience tab", audienceTab, "Raw geography with internal/admin traffic separated from external demand.");
