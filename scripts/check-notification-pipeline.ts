...
assertIncludes("Notification Funnel helper", funnelHelper, "Notification funnel is partial");
assertIncludes("Notification Funnel helper", funnelHelper, "denominatorMode");
assertIncludes("Notification Funnel helper", funnelHelper, "No permission sample");
assertIncludes("Notification Funnel helper", funnelHelper, "Delivery counts unavailable from Debug source.");
assertIncludes("Notification Funnel helper", funnelHelper, "Duplicate-prevention telemetry not instrumented.");
assertIncludes("Notification Funnel helper", funnelHelper, "Prompt, enabled, opened, read, and cleared are event counts.");
...
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-funnel-state");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-denominator-mode");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-step");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-step-source");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-step-status");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-step-freshness");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-reminder-reason-count");
assertIncludes("Notification Funnel component", funnelComponent, "data-notification-missing-source-count");
assertIncludes("Notification Funnel component", funnelComponent, "No permission sample");
assertNotIncludes("Notification Funnel component", funnelComponent, "Waiting");
