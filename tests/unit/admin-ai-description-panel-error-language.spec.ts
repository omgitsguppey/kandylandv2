...
const source = readFileSync(join(process.cwd(), "src/components/Admin/AiDropDescriptionGeneratorPanel.tsx"), "utf8");

describe("admin AI description generator panel error language", () => {
  it("maps generation and feedback failures through safe admin error language", () => {
    ...
    expect(source).toContain("getAdminAiDescriptionPanelSafeErrorMessage(error");
