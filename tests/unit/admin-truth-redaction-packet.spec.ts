...
describe("admin truth redaction packet", () => {
  it("defines a redaction-only packet and keeps admin source sample evidence missing", () => {
    ...
    expect(report.missingFormalProof).toContain("redacted admin source sample");
