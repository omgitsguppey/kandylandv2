...
function hydration(overrides: Partial<PersonMetricsHydrationReport> = {}): PersonMetricsHydrationReport {
  return {
    ...
    metricStatus: {
      ...
      daily_task_guidance_interactions: { metricId: "daily_task_guidance_interactions", count: 1, confidence: "exact", provenZero: false, sourceEvents: ["task_guidance_viewed", "task_guidance_tapped", "task_guidance_dismissed", "task_guidance_completed", "task_card_expanded", "task_help_opened"], hydratedEventIds: ["daily_task_guidance_1"], suppressedDuplicateCount: 0, missingSourceExplanation: "", state: "hydrated", lowConfidenceReason: null, missingProducer: null, missingBridge: null },
      ...
      search_discovery_actions: { metricId: "search_discovery_actions", count: 1, confidence: "exact", provenZero: false, sourceEvents: ["search_submitted"], hydratedEventIds: ["search_1"], suppressedDuplicateCount: 0, missingSourceExplanation: "", state: "hydrated", lowConfidenceReason: null, missingProducer: null, missingBridge: null },
      ...
      drop_unlocks: { metricId: "drop_unlocks", count: 2, confidence: "exact", provenZero: false, sourceEvents: ["drop_unlocked"], hydratedEventIds: ["unlock_1"], suppressedDuplicateCount: 0, missingSourceExplanation: "", state: "hydrated", lowConfidenceReason: null, missingProducer: null, missingBridge: null },
