...
describe("admin moderation routes", () => {
    ...
    it("returns the primary moderation security alert feed", async () => {
        mockState.listAdminModerationSecurityAlerts.mockResolvedValue([{
            ...
            riskScore: 5,
            riskTier: "low",
            riskConfidence: "heuristic",
            reasonCodes: ["possible_capture_theft_pattern"],
            positiveSignals: ["Possible capture/theft pattern from viewer heuristics only. (+3)"],
            negativeSignals: [],
            ...
            canAutoRestrict: false,
            accuracyLabel: "Needs review",
            falsePositiveRisk: "high",
            reviewPriority: "low",
            priorityLabel: "Monitor",
            actionLabel: "Do not act on this alone. Monitor for repeats or stronger signals.",
            contextLabel: "/dashboard/viewer",
            source: "protected_viewer",
            sourceLabel: "Protected viewer",
            sourceVerified: true,
