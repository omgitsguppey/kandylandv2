  ...
  it("maps blocked launch analytics consumers to truthful display states", () => {
    ...
    expect(detail.blockedConsumerDetails).toEqual(expect.arrayContaining([
      ...
      expect.objectContaining({
        ...
        nextAction: expect.stringContaining("charts waiting for source evidence"),
      }),
      expect.objectContaining({
          ...
          familySourceStates: [
            {
              ...
              confidenceScore: 100,
              confidenceBand: "verified",
              dedupeKey: "launch_recovery|page_view|event:no_event_id",
              dedupeDimensions: ["event_id", "session_id", "semantic_action"],
              lateArrivalWindowDays: 12,
              productTruthEligible: true,
              mathReason: "Observed first-party launch source evidence is available.",
            ...
            },
            {
              ...
              dedupeKey: "launch_recovery|purchase|event:no_event_id",
              dedupeDimensions: ["event_id", "session_id", "semantic_action"],
              lateArrivalWindowDays: 12,
              productTruthEligible: false,
              mathReason: "Missing first-party purchase facts.",
