        ...
        const signal = buildAdminAiDebugSignalInput({
            ...
            opsHealth: {
                ...
                diagnostics: {
                    ...
                    channels: [{
                        ...
                        truth: {
                            channel: "analytics",
                            lastSeenAtUtc: "1970-01-01T00:00:00.100Z",
                            freshnessState: "expired",
                            currentWindow: { windowMs: 21600000, errors: 1, warns: 0, info: 0, state: "error" },
                            recentWindow: { windowMs: 86400000, errors: 1, warns: 0, info: 0, state: "error" },
                            loadedSample: { sampleSize: 1, errors: 1, warns: 0, info: 0, state: "sample_error_history" },
                            overallState: "error",
                            explanation: "Current window has 1 analytics errors.",
                        },
                    }],
                ...
                materializers: [{
                    ...
                    truth: {
                        ...
                        errorState: "warn",
                        displayState: "review",
                        explanation: "No recent anonymous traffic in this window; ingest has no recorded failures.",
                    },
                }],
            },
            orchestration: {
                summary: {
                    ...
                    duplicateFindings: 0,
                    inspectOnlyFindings: 0,
                    criticalFindings: 0,
                    actionableProposals: 1,
                    inspectOnlyProposals: 0,
                    dedupedProposals: 1,
                    duplicateProposalsCollapsed: 0,
                    groupedProposalCards: 1,
                    groupedSourceRecordsCollapsed: 0,
                    contaminationRisks: 0,
                    trainingEligible: 4,
                    recommendationReady: 3,
                    lowConfidenceEvents: 1,
                    lowConfidenceRequiredEvents: 1,
                    evalEligibleDenominator: 10,
                    evalEligibleExplanation: "4 of 10 recent normalized events are eval eligible after excluding background, system, and identity-linkage records.",
                    penalties: [],
                },
                domainSummary: [{ key: "telemetry", domain: "telemetry", eventCount: 4, findingCount: 2, openFindingCount: 1, uniqueOpenFindings: 1, duplicateFindings: 0, inspectOnlyFindings: 0, trainingEligibleCount: 1, recommendationReadyCount: 1, lowConfidenceCount: 0, state: "review", explanation: "Unique findings are shown separately from duplicates and inspect-only items." }],
                dependencyReadiness: {
                    actorMissingCount: 0,
                    sessionMissingCount: 0,
                    routeMissingCount: 0,
                    creatorContextMissingCount: 0,
                    actorMissing: { requiredMissing: 0, optionalMissing: 0, backgroundExempt: 0, affectedDomains: [] },
                    sessionMissing: { requiredMissing: 0, optionalMissing: 0, backgroundExempt: 0, affectedDomains: [] },
                    routeMissing: { requiredMissing: 0, optionalMissing: 0, backgroundExempt: 0, affectedDomains: [] },
                    creatorContextMissing: { requiredMissing: 0, optionalMissing: 0, backgroundExempt: 0, affectedDomains: [] },
                },
                events: [],
            ...
            creatorOnboardingDiagnostics: {
                summary: {
                    ...
                    missingIdMetadataCount: 0,
                    agreementEvidenceIssueCount: 0,
                    stuckAwaitingReviewCount: 0,
                    roleMismatchCount: 0,
                    settingsIssueCount: 0,
                    historyCoverageIssueCount: 0,
                    reviewQueueOutOfSyncCount: 1,
                },
                issues: [{
                    ...
                    sourceSnapshots: {
                        ...
                        reviewQueueExists: false,
                        userProjectionExists: false,
                        userRole: "user",
