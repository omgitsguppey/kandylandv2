...
2. Keep operator-confirmed revenue smoke acknowledged without requiring provider-backed site activity evidence for that acknowledgement.
3. Attach provider-backed site activity evidence only when the operator chooses to clear the provider lane.
