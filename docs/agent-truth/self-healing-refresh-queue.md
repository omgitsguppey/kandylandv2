...
- Queue entries: 14
- Automatic entries: 10
- Blocked entries: 4
- Estimated score impact: 22.65

## Queue

### 1. agent/state/overnight-final-integration-lock.generated.json
...
### 11. provider_backed_site_activity_evidence
