...
- Remaining formal evidence gates: Visual/manual smoke: Visual QA required; Runtime/provider smoke: Runtime unverified; Admin truth/sample evidence: Ready with smoke required
