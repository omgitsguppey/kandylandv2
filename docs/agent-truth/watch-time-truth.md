...
- `skim`: 1s to 4.9s
- `viewed`: at least 5s image or 10s video/long content
- `engaged`: at least 15s or 50 percent video progress
- `completed`: at least 90 percent video progress, explicit completed state, or image visible and active for at least 10s
