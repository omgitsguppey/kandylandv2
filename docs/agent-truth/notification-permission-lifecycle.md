...
Generated: 2026-06-20T14:14:35.757Z
Current HEAD: a911e98
...
- runtimeHealth: 71.2 -> 71.2 (Runtime push/provider proof remains separate; this phase adds source-safe lifecycle readiness only.)
...
- freshness: 75.63 -> 75.63 (Notification lifecycle report is regenerated from current source.)
...
- overallHealthScore: 70.79 -> 70.79 (Moves notification readiness evidence without clearing formal runtime/provider gates.)
