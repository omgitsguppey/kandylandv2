...
- App routes scanned: 176
- Mapped routes: 163
- System/internal routes: 13
- Unmapped routes: 0
- Telemetry events: 770
...
- user_dashboard: owner=user-dashboard-analytics; routes=12; events=143; materializers=3; score=sourceHealth,evidenceCompleteness
...
- creator_dashboard: owner=creator-dashboard-analytics; routes=4; events=83; materializers=4; score=sourceHealth,evidenceCompleteness
...
- creator_drop_manager: owner=creator-drop-manager-analytics; routes=3; events=27; materializers=1; score=sourceHealth,evidenceCompleteness
...
- broadcasts: owner=broadcasts-analytics; routes=2; events=7; materializers=1; score=sourceHealth,evidenceCompleteness
- fan_pass: owner=fan-pass-analytics; routes=5; events=17; materializers=1; score=runtimeHealth,evidenceCompleteness
- admin_debug: owner=admin-debug-analytics; routes=3; events=123; materializers=1; score=sourceHealth,runtimeHealth,evidenceCompleteness,freshness
- analytics_telemetry: owner=analytics-platform; routes=3; events=278; materializers=5; score=sourceHealth,runtimeHealth,evidenceCompleteness,freshness
- cookie_consent_privacy: owner=privacy-analytics; routes=4; events=171; materializers=2; score=sourceHealth,evidenceCompleteness,regressionRisk
...
- runtime_smoke_substitutes: owner=runtime-evidence; routes=7; events=177; materializers=3; score=runtimeHealth,evidenceCompleteness,regressionRisk
- daily_checkin: owner=retention-analytics; routes=3; events=43; materializers=1; score=evidenceCompleteness
...
- support: owner=support-analytics; routes=6; events=53; materializers=1; score=runtimeHealth,evidenceCompleteness
...
- src/app/api/admin-ui-test-session/route.ts
