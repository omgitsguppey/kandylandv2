...
- user_dashboard: owner=user-dashboard-analytics; routes=12; events=86; materializers=3; score=sourceHealth,evidenceCompleteness
...
- creator_dashboard: owner=creator-dashboard-analytics; routes=4; events=28; materializers=4; score=sourceHealth,evidenceCompleteness
...
- fan_pass: owner=fan-pass-analytics; routes=5; events=7; materializers=1; score=runtimeHealth,evidenceCompleteness
...
- analytics_telemetry: owner=analytics-platform; routes=3; events=144; materializers=5; score=sourceHealth,runtimeHealth,evidenceCompleteness,freshness
- cookie_consent_privacy: owner=privacy-analytics; routes=4; events=104; materializers=2; score=sourceHealth,evidenceCompleteness,regressionRisk
- behavior_tracking: owner=behavioral-intelligence; routes=4; events=142; materializers=4; score=sourceHealth,runtimeHealth,evidenceCompleteness
- runtime_smoke_substitutes: owner=runtime-evidence; routes=7; events=111; materializers=3; score=runtimeHealth,evidenceCompleteness,regressionRisk
...
- support: owner=support-analytics; routes=6; events=18; materializers=1; score=runtimeHealth,evidenceCompleteness
