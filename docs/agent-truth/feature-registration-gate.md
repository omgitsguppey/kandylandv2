...
- analytics_telemetry: owner=analytics-platform; routes=3; events=187; materializers=5; score=sourceHealth,runtimeHealth,evidenceCompleteness,freshness
- cookie_consent_privacy: owner=privacy-analytics; routes=4; events=115; materializers=2; score=sourceHealth,evidenceCompleteness,regressionRisk
...
- auth_identity: owner=identity-analytics; routes=7; events=64; materializers=1; score=runtimeHealth,evidenceCompleteness
