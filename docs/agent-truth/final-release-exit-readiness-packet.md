...
- Generated: `2026-05-27T00:30:19.477Z`
...
```json
{
  ...
  "generatedAtUtc": "2026-05-27T00:30:19.477Z",
  ...
  "blockerClassifications": [
    {
      ...
      "nextExactAction": "Attach formal provider smoke and deployed runtime smoke evidence."
    },
    {
      "blocker": "Admin truth/sample evidence: Ready with smoke required",
      "classification": "formal_evidence_required",
      "nextExactAction": "Attach a redacted production admin truth sample packet."
    }
  ],
