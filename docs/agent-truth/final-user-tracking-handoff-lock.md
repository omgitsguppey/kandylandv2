...
Generated: 2026-07-14T16:24:38.298Z
Status: fail
...
- Admin source activity evidence: Stale evidence
...
- fail: chatNavUntouched
- fail: paymentGumdropMathUntouched
...
- agent/state/creator-drop-4xx-policy.generated.json
...
- agent/state/creator-drop-submit-repair.generated.json
- agent/state/creator-drop-workflow-contract.generated.json
...
- agent/state/current-head-release-reconciliation.generated.json
...
- agent/state/identity-chain-contract.generated.json
- agent/state/identity-handoff-4xx-policy.generated.json
- agent/state/identity-privacy-raw-ledger-rewire.generated.json
- agent/state/identity-tracking-memory-writeback.generated.json
...
- agent/state/release-notes-integrity.generated.json
...
- agent/state/unlock-transaction-source-metadata.generated.json
...
- docs/agent-truth/creator-drop-4xx-policy.md
- docs/agent-truth/creator-drop-submit-repair.md
- docs/agent-truth/creator-drop-workflow-contract.md
...
- docs/agent-truth/identity-chain-contract.md
- docs/agent-truth/identity-handoff-4xx-policy.md
- docs/agent-truth/identity-tracking-memory-writeback.md
...
- docs/agent-truth/unlock-transaction-source-metadata.md
...
- functions/src/scheduled-http-client.ts
...
- scripts/local-exe/KandyDropsLauncher.cs
- scripts/local-exe/build-local-exes.ps1
...
- src/lib/server/paypal-order-state.ts
...
- tests/unit/admin-auth-bounded-body-routes.spec.ts
- tests/unit/admin-bug-reports-route.spec.ts
- tests/unit/admin-content-route.spec.ts
- tests/unit/admin-core-bounded-body-routes.spec.ts
...
- tests/unit/analytics-identity-linking.spec.ts
- tests/unit/analytics-ingest-identified-route.spec.ts
- tests/unit/analytics-ingest-route.spec.ts
- tests/unit/auth-fetch-app-check.spec.ts
- tests/unit/automated-truth-reconciliation.spec.ts
...
- tests/unit/behavioral-timeline-projection.spec.ts
...
- tests/unit/creator-debug-drop-bounded-body-routes.spec.ts
...
- tests/unit/creator-profile-viewer-isolation.spec.tsx
...
- tests/unit/critical-user-bounded-body-routes.spec.ts
...
- tests/unit/formal-evidence-status-ledger.spec.ts
...
- tests/unit/local-exe-launcher.spec.ts
...
- tests/unit/no-sample-route-cohort-cleanup.spec.ts
...
- tests/unit/release-notes-integrity.spec.ts
- tests/unit/repo-doctrine-reset.spec.ts
- tests/unit/repo-inventory-stable-id.spec.ts
- tests/unit/scheduled-http-client.spec.ts
...
- tests/unit/server-unlock-telemetry-emission.spec.ts
- tests/unit/settings-connection-parity.spec.ts
- tests/unit/settings-debug-validator-authority.spec.ts
- tests/unit/settings-landing-upload-route.spec.ts
...
- tests/unit/tasks-materialize-route.spec.ts
- tests/unit/telemetry.spec.ts
- tests/unit/use-chat-unread-status.spec.tsx
- tests/unit/user-creator-ui-parity.spec.ts
- tests/unit/user-index-materializer-consumer.spec.ts
- tests/unit/user-index-materializer-core.spec.ts
- tests/unit/user-index-materializer-route.spec.ts
- tests/unit/user-index-materializer-schedule.spec.ts
...
- tests/unit/utils/source-validator-contract.ts
...
- protected file changed: REPO_MEMORY_LEDGER.md
- protected file changed: agent/state/canonical-math-ledger.generated.json
- protected file changed: agent/state/daily-task-reward-ledger.generated.json
- protected file changed: agent/state/formal-evidence-status-ledger.generated.json
- protected file changed: agent/state/gumdrop-economy-accuracy.generated.json
- protected file changed: agent/state/gumdrop-economy-score.generated.json
- protected file changed: agent/state/identity-privacy-raw-ledger-rewire.generated.json
- protected file changed: docs/agent-truth/canonical-math-ledger.md
- protected file changed: docs/agent-truth/daily-task-reward-ledger.md
- protected file changed: docs/agent-truth/formal-evidence-status-ledger.md
- protected file changed: scripts/agent/validate-canonical-math-ledger.ts
- protected file changed: scripts/agent/validate-chat-paid-gumdrops-guidance.ts
- protected file changed: scripts/agent/validate-fan-pass-gumdrops-truth.ts
- protected file changed: scripts/agent/validate-payment-unlock-security.ts
- protected file changed: src/app/api/chat/attachments/cancel/route.ts
- protected file changed: src/app/api/chat/attachments/complete/route.ts
- protected file changed: src/app/api/chat/attachments/prepare/route.ts
- protected file changed: src/app/api/chat/threads/[threadId]/messages/route.ts
- protected file changed: src/app/api/paypal/capture/route.ts
- protected file changed: src/app/api/paypal/create/route.ts
- protected file changed: src/components/Chat/ChatExperience.tsx
- protected file changed: src/components/Navigation/NotificationBell.tsx
- protected file changed: src/components/Navigation/ProfileDropdown.tsx
- protected file changed: src/lib/math/canonical-math-ledger.ts
- protected file changed: src/lib/server/chat.ts
- protected file changed: src/lib/server/paypal-order-state.ts
- protected file changed: src/lib/server/paypal.ts
- protected file changed: tests/unit/canonical-math-ledger.spec.ts
- protected file changed: tests/unit/formal-evidence-status-ledger.spec.ts
- protected file changed: tests/unit/paypal-capture-route.spec.ts
