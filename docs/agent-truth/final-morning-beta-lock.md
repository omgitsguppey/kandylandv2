...
Generated: 2026-05-20T22:06:55.480Z
...
- manual_screenshot_qa: missing; required_formal_lane; next: Attach screenshot evidence.
- runtime_smoke: missing; required_formal_lane; next: Attach deployed runtime proof.
- admin_truth_sample: missing; required_formal_lane; next: Attach redacted admin truth sample.
...
- P1 manual_evidence_missing: Attach manual screenshot QA evidence.
- P1 runtime_evidence_missing: Attach deployed runtime smoke evidence.
...
3. Attach manual screenshot, runtime smoke, and admin truth sample evidence before beta exit review.
