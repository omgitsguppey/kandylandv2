...
Generated: 2026-05-21T16:49:04.693Z
...
- Explanation: Cost risk score 71 reflects source cost readiness from guarded lanes; external billing review remains separate and no dollar savings are claimed.
...
| Cloud SQL/Data Connect | source_ready_no_runtime_usage_detected | true | true | Map Cloud SQL/Data Connect instance state, backups, HA, and billing owner in provider console. |
| Gemini/Cloud Assist/Vertex AI | source_guarded_external_review_remaining | true | true | Review Gemini/Vertex billing externally and keep future AI calls explicit, cached/idempotent, and rate-limited. |
| Route 4xx | source_guarded_external_review_remaining | true | false | Keep noisy 4xx routes typed, deduped, and non-retryable unless a validator proves retry is needed. |
| BigQuery | source_guarded_external_review_remaining | true | true | Verify BigQuery provider heartbeat/billing externally before treating warehouse evidence as full proof. |
| Analytics ingest/retry storms | source_guarded_external_review_remaining | true | false | Keep non-priority analytics batched and avoid retrying validation failures. |
| Scheduled/runtime job scan cost | source_guarded_external_review_remaining | true | true | Review deployed scheduler cadence and function billing externally before full closure. |
