export type QueueDropStatus = "active" | "expired" | "scheduled"
...
export function resolveDropStatusFromTiming(drop: DropTiming, now = Date.now()): QueueDropStatus {
